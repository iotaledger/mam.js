# Contribute to the JavaScript MAM library

This document describes how to contribute to the JavaScript MAM library.
...
To contribute to the JavaScript MAM library on GitHub, you can:
...
**Ensure the feature has not already been suggested** by searching on GitHub under [**Issues**](https://github.com/iotaledger/mam.js/issues).
...
The JavaScript MAM library documentation is hosted on https://docs.iota.org, which is built from content in the [documentation](https://github.com/iotaledger/documentation) repository.
